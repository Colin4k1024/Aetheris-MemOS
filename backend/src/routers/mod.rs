...
pub fn root() -> Router {
    ...
    let protected_api_router = Router::new()
        ...
        .nest(
            "/v1/distillation",
            Router::new()
                .route("/trigger", post(distillation::trigger_distillation))
                .route("/atoms", get(distillation::list_atoms))
                .route("/atoms/{id}", get(distillation::get_atom))
                .route("/scenes", get(distillation::list_scenes))
                .route("/scenes/{id}", get(distillation::get_scene))
                .route("/persona", get(distillation::get_persona))
                .route("/jobs", get(distillation::list_jobs)),
        )
